...
| ⑧ | **Borrow methodology, not surface** | Duplicated knowledge drifts; borrowed surfaces multiply until nobody uses them | Share canonical contracts across Claude and Codex; keep repository-maintainer skills local; bundle only self-authored artifacts; reference externally maintained skills; absorb external *methodologies* as credited rewrites; record what was declined and why | Vendoring skills, or adopting every good idea as one more command |
