...
allowed-tools: Read, Write, Edit, AskUserQuestion, Bash(command:*), Bash(claude plugin list:*), Bash(claude plugin install:*), Bash(npm i -g playwright-cli:*), Bash(test:*), Bash(grep:*), Bash(cp:*), Bash(mkdir:*), Bash(gh auth status:*), Bash(gh api user/starred/S-jooyoung/oh-my-joy:*)
---
